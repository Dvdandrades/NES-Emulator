...
pub struct NesPPU {
    ...
    pub vram: [u8; 2048], // 2KiB background information
...
impl NesPPU {
    ...
    fn _poll_nmi_interrupt(&mut self) -> Option<u8> {
...
pub mod test {
    ...
    #[test]
    fn test_ppu_vram_reads_croos_page() {
        let mut ppu = NesPPU::new_empty_rom();
        ppu.write_to_ctrl(0);
    ...
    // Horizontal: https://www.nesdev.org/wiki/Mirroring#:~:text=Horizontal,-A%20vertical
    //   [0x2000 A ] [0x2400 a ]
    //   [0x2800 B ] [0x2C00 b ]
    #[test]
    ...
    // Vertical: https://www.nesdev.org/wiki/Mirroring#:~:text=Vertical,-A%20horizontal
    //   [0x2000 A ] [0x2400 B ]
    //   [0x2800 a ] [0x2C00 b ]
    #[test]
